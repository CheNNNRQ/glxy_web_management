<template>
  <div>
    <div class="app-container">课程列表</div>
    <!-- 多条件查询表单 -->
    <el-form
      :inline="true"
    ...
    >
      ...
      <el-form-item label="发布状态">
        <el-select v-model="courseQuery.status" placeholder="讲师头衔">
          <el-option label="Normal已发布" :value="Normal"></el-option>
          <el-option label="Draft未发布" :value="Draft"></el-option>
        </el-select>
      </el-form-item>
